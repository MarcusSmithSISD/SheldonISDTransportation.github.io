...
function renderPage(pageIndex){
    ...
    page.forEach(trip=>{
        ...
        <td><strong>${trip[COLUMN.TRIP] || ""}</strong></td>
...
const originalProcessTrips = processTrips;

processTrips = function(data){

    originalProcessTrips(data);
